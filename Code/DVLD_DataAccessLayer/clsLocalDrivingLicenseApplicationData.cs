    ...
    public class clsLocalDrivingLicenseApplicationData
    {
            ...
            ref int ApplicationID, ref int LicenseClassID)
        {
            ...
            string query = @"SELECT * FROM LocalDrivingLicenseApplications
                              WHERE LocalDrivingLicenseApplicationID = @LocalDrivingLicenseApplications";
            SqlCommand command = new SqlCommand(query, connection);
            command.Parameters.AddWithValue("@LocalDrivingLicenseApplications", LocalDrivingLicenseApplicationID);
        ...
        public static int AddNewLocalDrivingLicenseApplication(int ApplicationID, int LicenseClassID)
        {
            ...
            {
                Console.WriteLine("Error adding new local driving license application: " + ex.Message);
            }
            finally
            {
                connection.Close();
